    ...
    def build_prompt(
        ...
        *,
        ...
        system = (
            ...
            "and secure the earliest safe retirement. Your resolution must "
            "be evaluated through this lens — not just 'what avoids risk.' "
            "Conservatism-that-delays-FI is anti-goal; risk-acceptance that "
            "accelerates FI within safety bounds is the right call. "
            "Safety bounds = hard legal/tax constraints, catastrophic-"
            "drawdown tail risk the family cannot recover from, explicit "
            "user-asserted limits. Everything else is goal-trade-off "
            "territory — prefer FM_ACCEPTS_ANALYST when the analyst's "
            "evidence shows the original objection costs FI progress "
            "without genuine safety justification.\n\n"
