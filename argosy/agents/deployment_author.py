    ...
    def build_prompt(
        ...
        *,
        ...
        system = (
            ...
            "INCLUDING its US-equity sleeves. A broad, diversified fund's INCIDENTAL "
            "few-percent NVDA look-through (e.g. CSPX is ~7% NVDA) is NOT a reason to "
            "decline it — the marginal single-name add is trivial. Only steer away from "
            "instruments that are THEMSELVES NVDA-heavy or otherwise single-name "
            ...
            "asymmetry (upside x plausibility / DOWNSIDE) names get the tranche "
            "first. A countable downside FLOOR raises a name's rank; generic "
            "'safer' / larger / "
