...
OWNER_MAP: dict[str, OwnerSpec] = {
    ...
    "retirement.fire_bridge_offmandate_nis": OwnerSpec(_R, _FR, _MED),
    "retirement.fi_age": OwnerSpec(_R, _MP, _HI),
    "retirement.earliest_safe_age": OwnerSpec(_R, _MP, _HI),
    "retirement.preservation_age": OwnerSpec(_R, _MP, _HI),
    "retirement.drawdown_scenario_age": OwnerSpec(_R, _MP, _MED),
