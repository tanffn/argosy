...
| Deploy idle cash to the plan (risk-tiered, estate-aware buy list) | `argosy/services/deployment_advisor.py` (`assemble_deployment_plan`) + `argosy/services/high_potential_sleeve.py` (the moonshot sleeve) | §20.5; `GET /api/portfolio/deploy-cash`; `ui/src/components/proposals/DeployCashCard.tsx`; spec `docs/superpowers/specs/2026-06-12-deployment-advisor-design.md` |
