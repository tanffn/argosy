...
**Currently shipping:** ALL PHASES SHIPPED. Smoke-tested end-to-end against v20 fixture via `tools/smoke_test_gate_against_v20.py` — gate detects 188 violations on the frozen baseline (77 history + 109 jargon + 1 coverage + 1 evidence), proving every defect-detection path is wired correctly. Next: a supervised real-data synth cycle under the new pipeline + hand-check of v22 output quality. Last update: 2026-06-02.
