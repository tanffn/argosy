...
Durable facts about who the household *is*. These drive estate-tax situs, treaty
...
- **Not a US person** — no citizenship, no green card. Therefore a
  **non-resident alien (NRA)** for US estate and gift tax.
...
- **Israeli tax resident.**
- **German citizen.**
- **NOT a US person** — no US citizenship, no green card. (Ariel, 2026-08-23.)
...
3. **She has her own USD 60,000 exemption and her own graduated rate ladder** —
   but only over assets she *solely* owns. Joint registration forfeits this.
4. **German citizenship is not automatically useless here.** A US–Germany estate
   ...
   not nationality, and she is Israeli-domiciled. Separately, German inheritance
   tax (ErbStG §2) has an extended-liability rule for German nationals who
   emigrated recently. Both need checking before being relied on or dismissed.

## Accounts

**Registration is JOINT — Ariel and Noga** (Ariel, 2026-08-23). Given point 2
above this is currently the *worst* structure for US estate tax: it maximises
first-death inclusion instead of splitting the base across two exemptions.

## Real estate

- **Israeli primary residence ("Keret")** — roughly ILS 3M.
- **Atlanta, USA — GONE, and not US-situs.** Ariel paid an advance to a developer
  ...
  not a current holding; the mortgage was never drawn.
- **Romania — two units, Pipera and Obor** (EUR-denominated).

## Capital losses

**No Israeli capital-loss carryforwards are available** (Ariel, 2026-08-23) — an
earlier loss was already refunded by the Israeli tax authority. Any strategy that
depends on harvesting gains against carried-forward losses is therefore dead on
arrival; do not propose it again without a fresh loss schedule.
